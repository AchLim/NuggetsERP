...
[ApiController]
[Route("v{version:apiVersion}/purchase-receipt")]
[ApiVersion("1.0")]
public class PurchaseReceiptController(ILogger<PurchaseReceiptController> logger, IPurchaseReceiptService service) : ControllerBase
{
    private readonly ILogger<PurchaseReceiptController> _logger = logger;
    ...
    public async Task<IActionResult> Update(Guid id, PurchaseReceiptUpdateDto dto)
    {
