...
[ApiController]
[Route("v{version:apiVersion}/purchase-order")]
[ApiVersion("1.0")]
public class PurchaseOrderController(ILogger<PurchaseOrderController> logger, IPurchaseOrderService service) : ControllerBase
{
    ...
    public async Task<IActionResult> Update(Guid id, PurchaseOrderUpdateDto dto)
    {
