...
public sealed record PurchaseReceiptLineReadDto(Guid Id, Guid ProductId, string? ProductName, Guid UomId, decimal Quantity, decimal UnitCost, decimal DiscountPercent, decimal LineTotal);
public sealed record PurchaseReceiptLineCreateDto(Guid? Id, Guid ProductId, Guid UomId, decimal Quantity, decimal UnitCost, decimal DiscountPercent);
public sealed record PurchaseReceiptLineUpdateDto(Guid Id, Guid ProductId, Guid UomId, decimal Quantity, decimal UnitCost, decimal DiscountPercent);